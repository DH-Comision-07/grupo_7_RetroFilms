...
router.post('/', upload.fields([{name:'poster', maxCount:1},{name:'imagesMovie', maxCount: 4}]), productController.add)

// ----- EDIT PRODUCT ----//
router.get('/productDetail/:id/edit', productController.edit);
router.put('/:id' , upload.fields([{name:'poster', maxCount:1},{name:'imagesMovie', maxCount: 4}]), productController.save)
