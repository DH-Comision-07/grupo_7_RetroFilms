...
const productController = { 
    //productDetail: (req, res) => res.render("products/productDetail/"), //añadí la carpeta products que nos pidieron añadir en el sprint pasado, pues sin ella no renderisa la vista
    ...
    add: (req, res) => res.send('quedó guardado') //incorrecto-corregir
}
