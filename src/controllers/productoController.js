...
const productoController = { 
    detalleProducto: (req, res) => res.render("products/detalleProducto",{movieDetails: productoService.getOneBy(req.params.id)}),//TODO: (LAURA) cambiar el valor de 1 por el parametro del id //añadí la carpeta products que nos pidieron añadir en el sprint pasado, pues sin ella no renderisa la vista
